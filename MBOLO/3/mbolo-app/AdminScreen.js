...
function AdminScreen({ }) {
  ...
  //Estas son las funciones que usamos para cargar los datos de nuestra Base de datos
  async function getAllData() {
    axios.get("http://192.168.100.235:3000/get-all-user").then((res) => {
  ...
  async function getData() {
    ...
    console.log(token);
    axios
      .post("http://192.168.0.108:3000/userdata", { token: token })
      .then((res) => {
        console.log(res.data);
  ...
  function deleteUser(data) {
    axios
      .post("http://192.168.0.108:3000/delete-user", { id: data._id })
      .then((res) => {
        console.log(res.data);
