...
export default function UpdateProfile() {
  ...
  const updateProfile = () => {
    ...
    axios
      .post("http://192.168.100.235:3000/update-user", formdata)
      .then((res) => {
      ...
      <View>
        ...
        <View
          ...
          <View style={styles.infoEditView}>
            <Text style={styles.infoEditFirst_text}>Nombre</Text>
            <TextInput
          ...
          <View style={styles.infoEditView}>
            <Text style={styles.infoEditFirst_text}>Genero</Text>
          ...
          <View style={styles.infoEditView}>
            <Text style={styles.infoEditFirst_text}>Profesion</Text>
            <TextInput
          ...
          <View style={styles.infoEditView}>
            <Text style={styles.infoEditFirst_text}>Telefono</Text>
            <TextInput
        ...
        <View style={styles.button}>
          <TouchableOpacity
            ...
            style={styles.inBut}>
            <View>
              <Text style={styles.textSign}>Actualizar mi perfil</Text>
            </View>
          </TouchableOpacity>
        </View>
      </View>
